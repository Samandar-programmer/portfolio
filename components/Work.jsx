    ...
    className='w-full px-[12%] py-10 scroll-mt-20' id='work'>
      ...
      className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 my-10 dark:text-black'>
        {currentItems.map((project, index)=>(
          ...
          key={index} style={{backgroundImage: `url(${project.bgImage.src})`}} href={project.link} target='_blank' className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group hover:shadow-black transition duration-500 border border-gray-300 dark:border-gray-700 dark:hover:shadow-white'>
